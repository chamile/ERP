...
describe('Testing Inboxervice.js api calls', () => {
  ...
  test('should get inbox list', async (done) => {
    const data = await API.get(`api/biz/filetags/IncomingMail|IncomingEHF|IncomingTravel|IncomingExpense/0?action=get-supplierInvoice-inbox`);
