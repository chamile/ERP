...
describe('Testing CompanyService.js api calls', () => {
  ...
  test('should load deparments list', async (done) => {
    const data = await API.get(`api/biz/departments/?select=ID, DepartmentNumber, Name`);
