...
describe('Testing AutoCompleteService.js api calls', () => {
  ...
  test('should get suggestion list', async (done) => {
    const data = await API.get(`api/biz/users?filter=contains(DisplayName,'ch')`);
