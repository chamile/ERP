...
describe('TestingS NotificationService.js api calls', () => {
  ...
  test('should get notification count', async (done) => {
    const data = await API.get(`api/biz/notifications?action=count`);
  ...
  test('should get notification List', async (done) => {
    const data = await API.get(`api/biz/notifications?top=0&orderby=ID desc,CreatedAt asc,CreatedBy&skip=0`);
