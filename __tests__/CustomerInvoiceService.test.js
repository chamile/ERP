...
describe('Testing CustomerInvoiceService.js api calls', () => {
  ...
  test('should get invoice details', async (done) => {
    const data = await API.get(`api/biz/invoices/1?expand=Items, currencycode, Items.CurrencyCode, Items.VatType, DefaultDimensions.Project, DefaultSeller`);
