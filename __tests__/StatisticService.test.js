...
describe('TestingS StatisticService.js api calls', () => {
  ...
  test('should get statistic data', async (done) => {
    const data = await API.get(`api/biz/workrelations/1?action=calc-flex-balance&date='2018-01-03'&details=true`);
