...
export default class OnBoardView extends  React.PureComponent {
  ...
  handlePushRegistration(device) {
    if (device.pushToken) {
      ...
      this.registerDevice(device.userId);
    }
  }
          ...
          <ScrollView>
            ...
            <View style={styles.imageContainer}>
              <Image
                ...
                source={require('../../images/OnBoarder/allow-push-notifications.png')}
              />
            </View>
            ...
            <Animated.View pointerEvents={this.state.submitAnimation === 0 ? 'none' : 'auto'} style={{ backgroundColor: '#FFF', opacity: this.state.submitAnimation }}>
              <RoundedButton text={i18n.t('OnBoard.OnBoardView.letsDoThis')} width={200} color={theme.PRIMARY_COLOR} borderWidth={1} onPress={this.onAllowButtonTap} />
            </Animated.View>
