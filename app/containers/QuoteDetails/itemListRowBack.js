    ...
    <View style={styles.rowBack}>
      ...
      <View style={[styles.quickActionButtonsBox, styles.rightQuickPanel]}>
        ...
        >
          ...
          <Text style={styles.quickActionButtonText}>{i18n.t('QuoteDetails.itemListRow.edit')}</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Text style={styles.quickActionButtonText}>{i18n.t('QuoteDetails.itemListRow.delete')}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
