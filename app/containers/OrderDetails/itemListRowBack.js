    ...
    <View style={styles.rowBack}>
      ...
      <View style={[styles.quickActionButtonsBox, styles.rightQuickPanel]}>
        ...
        >
          ...
          <Text style={styles.quickActionButtonText}>{i18n.t('OrderDetails.itemListRow.edit')}</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Text style={styles.quickActionButtonText}>{i18n.t('OrderDetails.itemListRow.delete')}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
